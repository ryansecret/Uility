...
using Uility.Notifications;
using Uility.QueueProcessor;
    ...
    public class NotificationItemProcessor
    {
        ...
        public void Process(NotificationMessage currentMessage)
        {
            try
            {
                ...
                messageBody = Substitute(currentMessage.Values, messageBody);
                
                // Now replace using the global notification substitution settings.
                messageBody =  Substitute(_settings.Settings, messageBody);
