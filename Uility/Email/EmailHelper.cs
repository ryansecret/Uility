...
namespace ComLib.EmailSupport
{
    ...
    public class EmailHelper
    {
        ...
        /// <returns></returns>
        public static IEmailSettings GetSettings(IDictionary config, string emailServiceSectionName,
                                                 Func<IEmailSettings> settingsCreator = null)
        {
            IEmailSettings settings = settingsCreator == null ? new EmailServiceSettings() : settingsCreator();
            settings.IsAuthenticationRequired = GetOrDefault(config, emailServiceSectionName, "IsAuthenticationRequired",
                                                             false);
